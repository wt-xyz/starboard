...
describe('Funding Calculator - Cost Calculations', () => {
  describe('calculateFundingCost', () => {
    it('should calculate funding cost correctly for 24 hours', () => {
      ...
      const cost = calculateFundingCost(new BigNumber(50000), new BigNumber(0.0001), 24);
    ...
    it('should calculate funding cost correctly for 8 hours', () => {
      ...
      const cost = calculateFundingCost(new BigNumber(50000), new BigNumber(0.0001), 8);
    ...
    it('should return zero for zero position size', () => {
      const cost = calculateFundingCost(new BigNumber(0), new BigNumber(0.0001), 24);

      expect(cost.toNumber()).toBe(0);
    });

    it('should return zero for zero funding rate', () => {
      const cost = calculateFundingCost(new BigNumber(50000), new BigNumber(0), 24);

      expect(cost.toNumber()).toBe(0);
    });

    it('should maintain accuracy to 6 decimal places', () => {
      const cost = calculateFundingCost(new BigNumber(123.456789), new BigNumber(0.000123), 17);
  ...
  describe('calculateFundingCostSafe', () => {
    it('should calculate normally for valid inputs', () => {
      const result = calculateFundingCostSafe(new BigNumber(50000), new BigNumber(0.0001), 24);
    ...
    it('should handle infinite values gracefully', () => {
      const result = calculateFundingCostSafe(new BigNumber(Infinity), new BigNumber(0.0001), 24);
...
describe('Funding Calculator - Historical Analysis', () => {
  describe('calculateFundingCostRange', () => {
    it('should calculate cost range based on historical data', () => {
      ...
      expect(range.pessimistic.abs().toNumber()).toBeGreaterThan(range.optimistic.abs().toNumber());
    });
