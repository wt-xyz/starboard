...
const headerChildrenBag = {
  ...
  SizeDelta: propifyEl('th', { className: $.headerCell, children: 'Size' }),
  ...
  PnlDelta: propifyEl('th', { className: $.headerCell, children: 'PnL' }),
  Time: propifyEl('th', { className: $.headerCell, children: 'Time' }),
  TradeValue: propifyEl('th', { className: $.headerCell, children: 'Trade Value' }),
  Fees: propifyEl('th', { className: $.headerCell, children: 'Fees' }),
  Direction: propifyEl('th', { className: $.headerCell, children: 'Direction' }),
