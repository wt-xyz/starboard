export default class Data1768329135947 {
    ...
    async up(db) {
        await db.query(`CREATE TABLE "price" ("id" character varying NOT NULL, "asset" text NOT NULL, "oracle_timestamp" integer NOT NULL, "timestamp" integer NOT NULL, "price" numeric NOT NULL, CONSTRAINT "PK_d163e55e8cce6908b2e0f27cea4" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_c70fa4f1953ea41d18d7cfc3c2" ON "price" ("asset", "oracle_timestamp") `)
